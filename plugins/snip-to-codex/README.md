...
![使用面板](assets/welcome.png)

## 普通用户：三分钟开始使用

1. 打开本项目的 **Releases（发行版）**，进入最新版本。
2. 在 **Assets** 下载 **SnipToCodex-v1.1.0-windows-x64.zip**，不要选择给开发者用的 Source code。
...
**完整教学：** [一步一步的中文教程](docs/使用教程.md)；下载后也可直接打开 `docs/guide.html`，支持离线阅读和打印。

## 截图时怎么操作

![框选截图示例](assets/selection.png)
...
默认快捷键冲突时会改用 **Ctrl+Alt+F8**，实际组合以软件面板为准。关闭面板后仍可通过快捷键截图。默认不开机自启。
